...
function create_if_block_1(ctx) {
	let div0;
	let t0_value = constants.roundTemp(/*period*/ ctx[0].temp.min) + "";
	let t0;
	let t1;
	let span0;
	let t3;
	...
	let t5;
	let div1;
	let t6_value = constants.roundTemp(/*period*/ ctx[0].temp.max) + "";
	let t6;
	let t7;
	let span2;
	let t9;
	...
	const block = {
		c: function create() {
			...
			span3.textContent = "C";
			attr_dev(span0, "class", "degree_symbol");
			add_location(span0, file, 25, 10, 658);
			attr_dev(span1, "class", "temperature_unit");
			add_location(span1, file, 26, 10, 709);
			...
			add_location(div1, file, 28, 8, 773);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div0, anchor);
			append_dev(div0, t0);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*period*/ 1 && t0_value !== (t0_value = constants.roundTemp(/*period*/ ctx[0].temp.min) + "")) set_data_dev(t0, t0_value);
			if (dirty & /*period*/ 1 && t6_value !== (t6_value = constants.roundTemp(/*period*/ ctx[0].temp.max) + "")) set_data_dev(t6, t6_value);
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(div0);
			if (detaching) detach_dev(t5);
...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*days*/ 1) weatherinfo_changes.period = /*day*/ ctx[22];
...
function create_if_block_2$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(308:12) {#if day.hours.length > 4}",
		ctx
	});
...
// (316:22) {#if h1 % Math.ceil(day.hours.length / 4) == 0}
function create_if_block_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(316:22) {#if h1 % Math.ceil(day.hours.length / 4) == 0}",
		ctx
	});
...
// (311:18) {#each day.hours as hour, h1}
function create_each_block_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(311:18) {#each day.hours as hour, h1}",
		ctx
	});
...
// (339:8) {#each constants.available_locations as loc}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(339:8) {#each constants.available_locations as loc}",
		ctx
	});
